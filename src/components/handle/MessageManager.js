...
const unknownError = () => { alert(i18n.messages.unknownError); }
const successfullyCreated = () => { alert(i18n.messages.successfullyCreated); }
const successfullyEdited = () => { alert(i18n.messages.successfullyEdited); }
const successfullyDeleted = () => { alert(i18n.messages.successfullyDeleted); }
const errorStaus400 = () => { alert(i18n.messages.errorStaus400); }
const errorStaus403 = () => { alert(i18n.messages.errorStaus403); }
const errorStaus409 = () => { alert(i18n.messages.errorStaus409); }
const invalidCredentials = () => { alert(i18n.messages.invalidCredentials); }
