...
const Form = (props) => {
  ...
  const handleAdd = () => {
    ...
    if(isValid){
      if(isEdit) {
        handleEdit("subjects/", body, id, handleReset, setIsEdit)
      } else {
        handleCreate("subjects/", body, handleReset);
      }
    }
  };
      ...
      <div className="container col-md-4">
        <div className="card">
          <div className="card-header">
            <h3 align="center">{i18n.subjectForm.formTitle}</h3>
          </div>
          <div className="card-body">
            <form className="">
              <FormInput
                labelContent={i18n.subjectForm.formLabelName} 
                formText={i18n.subjectForm.formTextName}
